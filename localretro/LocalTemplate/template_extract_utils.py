...
def check_bond_change(pbond, rbond):
    if pbond == None or rbond == None:
        return False
    elif bond_to_label2(pbond) != bond_to_label2(rbond):
        return True
    else:
        return False
...
def label_edit_site(products, reactants, edit_num):
...
def match_label(products, reactants, replacement_dict, edit_num):
    ...
    edit_sites = label_edit_site(products, reactants, edit_num)
